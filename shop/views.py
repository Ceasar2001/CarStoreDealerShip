...
def category(request, category):
    scooter_items = Item.objects.filter(category='Scooter')
    atv_items = Item.objects.filter(category='Atv')
    cars_items = Item.objects.filter(category='Cars')
    automobile_items = Item.objects.filter(category='Automobile')

    return render(request, 'category.html',
                  {
                      'category': category, 'scooter_items': scooter_items, 'atv_items': atv_items,
                      'cars_items': cars_items, 'automobile_items': automobile_items
                  })
